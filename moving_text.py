...
with open(sys.argv[1], "r", encoding="utf-8") as file:
    ...
    screensize = (textInfo["width"] , textInfo["height"])
    txtClip = TextClip(textInfo["text"],color=textInfo["fontColor"], font=textInfo["font"],
                 size=(textInfo["width"], textInfo["height"]), method='caption', fontsize=textInfo["fontSize"], kerning=-1)
    ...
    def arrive(screenpos,i,nletters):
        ...
        return lambda t: screenpos-300*v*d(t)
    ...
    def vortexout(screenpos,i,nletters):
        ...
        v = rotMatrix(a).dot([-1,0])
        if i%2 : v[1] = -v[1]
        return lambda t: screenpos+400*d(t)*rotMatrix(-0.2*d(t)*a).dot(v)
    ...
    final_clip.write_videofile(textInfo["outputFilePath"], codec="libx264")